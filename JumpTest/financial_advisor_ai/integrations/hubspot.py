    ...
    def get_contacts(self, limit=50, properties=None) -> List[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Error fetching HubSpot contacts: {response.status_code} - {response.text}")
                return []
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                if contact_id:
                    ...
                    logger.info(f"Created HubSpot contact: {contact_id} - {email}")
                    return contact_id
                else:
    ...
    def update_contact(self, contact_id: str, properties: Dict) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Error updating HubSpot contact: {response.status_code} - {response.text}")
                return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if contacts:
                    ...
                    logger.info(f"No HubSpot contact found with email: {email}")
                    return None
            else:
                logger.error(f"Error searching for HubSpot contact: {response.status_code} - {response.text}")
                return None
    ...
    def add_note_to_contact(self, contact_id: str, note_body: str) -> Optional[str]:
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                logger.info(f"Created note for contact {contact_id}: {note_id}")
                return note_id
            else:
                logger.error(f"Error adding note to contact: {response.status_code} - {response.text}")
                return None
    ...
    def create_meeting(self, contact_id: str, title: str, description: str, 
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                logger.info(f"Created meeting with contact {contact_id}: {meeting_id}")
                return meeting_id
            else:
