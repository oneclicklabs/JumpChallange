...
class GmailAPI:
    ...
    def sync_emails_to_db(self, days=7) -> int:
        ...
        try:
            ...
            for email in emails:
                ...
                contacts = HubspotContact.objects.filter(user=self.user, email__iexact=from_email)
                    ...
                    if not existing.exists():
                        ...
                        if email.get('date'):
                            try:
                                ...
                                received_at = parsedate_to_datetime(email.get('date'))
                            except:
                                pass
