...
def main():
    ...
    print("="*80)
    print(f"Core Tests: {'PASS' if core_failures == 0 else 'FAIL'} ({core_failures} failures)")
    print(f"Integration Tests: {'PASS' if integration_failures == 0 else 'FAIL'} ({integration_failures} failures)")
    print("-"*80)
    print(f"Overall: {'PASS' if total_failures == 0 else 'FAIL'} ({total_failures} total failures)")
    print("="*80 + "\n")
